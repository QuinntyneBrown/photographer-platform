...
namespace Chloe.Server.Controllers
{
    ...
    public class CustomerController : ApiController
    {
        ...
        [Route("add")]
        [HttpPost]
        public IHttpActionResult Add(CustomerAddOrUpdateRequestDto dto) { return Ok(this.service.AddOrUpdate(dto)); }

        [Route("update")]
        [HttpPut]
        public IHttpActionResult Update(CustomerAddOrUpdateRequestDto dto) { return Ok(this.service.AddOrUpdate(dto)); }
